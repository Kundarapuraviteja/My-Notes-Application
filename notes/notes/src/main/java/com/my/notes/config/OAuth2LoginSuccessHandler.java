...
//    https://tm.udemy.com/course/spring-security-6-with-reactjs-oauth2-jwt-multifactor-authentication/learn/lecture/45131977#content
...
// Check if email is missing and handle accordingly
        if (email.isEmpty()) {
            // You might want to generate a temporary email or ask the user for it later
            email = username + "@noemail.com"; // Example fallback, adjust as needed
        }

// Handle missing name
        if (name.isEmpty()) {
            name = username; // Fallback to username if name is missing
        }
