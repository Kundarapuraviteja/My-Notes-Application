  ...
  return (
    <div className="min-h-[calc(100vh-74px)] flex justify-center">
      <div className="lg:w-[80%] w-full py-16  space-y-4  ">
        ...
        >
       Capture your ideas quickly, securely, and stay organized with ease

        </motion.h1>
        <h3 className="text-logoText md:text-2xl text-xl font-semibold text-slate-800 text-center">
          Presenting the My Notes App
        </h3>
        <p className="text-slate-700 text-center sm:w-[80%] w-[90%] mx-auto">
        Effortlessly create and manage your notes with top-notch security. Type, save, and access them anytime, anywhere—backed by strong encryption and smooth syncing.
        </p>
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        <div className="sm:pt-14 pt-0 xl:px-16 md:px-10">
          ...
          Why Companies Around the World Trust and Rely on Workable
          </h1>
          <Brands />
          <State />
          <div className="pb-10">
